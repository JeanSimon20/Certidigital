...
INSERT INTO users (
    ...
    'Super Administrator',
    '$2a$12$2l5a0NBpAteuaGzQ2D.QlOfbMuPH4nVVW6aHlWBxC.F7fCqof9qDK', -- SuperAdmin@2024!
    'ACTIVE',
    TRUE,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
...
INSERT INTO users (
    ...
    'user-org-0002-aaaa-bbbb-cccccccc',
    'maria.gonzalez@unitech.edu.hn',
    'Lic. María González',
    '$2a$12$SRN6up8sy8azhDuKCBd3quU05ysC6PDoRZYfTLSyZFInWmaQrfMvu', -- Organizer@2024!
    'ACTIVE',
    TRUE,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
...
-- Organizer
INSERT INTO roles (id, tenant_id, name, description, is_system_role, status, created_at, updated_at)
VALUES ('role-organizer-0000000000000000', NULL,
        'ORGANIZER', 'Organizador de eventos. Crea y gestiona eventos, inscripciones y asistencia.',
        TRUE, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Credential Approver
INSERT INTO roles (id, tenant_id, name, description, is_system_role, status, created_at, updated_at)
VALUES ('role-approver-0000000000000000', NULL,
...
INSERT INTO role_permissions (id, role_id, resource, action) VALUES
    ('perm-or-001', 'role-organizer-0000000000000000', 'event', 'create'),
    ('perm-or-002', 'role-organizer-0000000000000000', 'event', 'read'),
    ('perm-or-003', 'role-organizer-0000000000000000', 'event', 'update'),
    ('perm-or-004', 'role-organizer-0000000000000000', 'event', 'publish'),
    ('perm-or-005', 'role-organizer-0000000000000000', 'event', 'close'),
    ('perm-or-006', 'role-organizer-0000000000000000', 'enrollment', 'create'),
    ('perm-or-007', 'role-organizer-0000000000000000', 'enrollment', 'read'),
    ('perm-or-008', 'role-organizer-0000000000000000', 'attendance', 'record'),
    ('perm-or-009', 'role-organizer-0000000000000000', 'evaluation', 'record'),
    ('perm-or-010', 'role-organizer-0000000000000000', 'payment', 'confirm'),
    ('perm-or-011', 'role-organizer-0000000000000000', 'credential', 'read');
...
-- CREDENTIAL_APPROVER
INSERT INTO role_permissions (id, role_id, resource, action) VALUES
    ('perm-ca-001', 'role-approver-0000000000000000', 'issuance', 'approve'),
    ('perm-ca-002', 'role-approver-0000000000000000', 'issuance', 'reject'),
    ('perm-ca-003', 'role-approver-0000000000000000', 'issuance', 'read'),
    ('perm-ca-004', 'role-approver-0000000000000000', 'credential', 'read'),
    ('perm-ca-005', 'role-approver-0000000000000000', 'enrollment', 'read');
...
VALUES ('memb-admin-0001-aaaa-bbbb-cccccccc',
        'user-admin-0001-aaaa-bbbb-cccccccc',
        'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO organization_profiles (
    ...
    'orgp-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'Universidad Tecnológica del Norte',
    'UniTech',
...
INSERT INTO digital_certificates (
    ...
    'cert-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO credential_templates (
    ...
    'tmpl-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO issuance_policies (
    ...
    'policy-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
VALUES ('cond-001-aaaa-bbbb-cccc-dddddddd',
        'policy-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO policy_conditions (id, policy_id, condition_type, threshold_value, description)
VALUES ('cond-002-aaaa-bbbb-cccc-dddddddd',
        'policy-001-aaaa-bbbb-cccc-dddddddd',
        'MIN_SCORE', 70.00,
...
INSERT INTO policy_conditions (id, policy_id, condition_type, threshold_value, description)
VALUES ('cond-003-aaaa-bbbb-cccc-dddddddd',
        'policy-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO events (
    ...
    'event-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
VALUES ('sess-001-aaaa-bbbb-cccc-dddddddd',
        'event-001-aaaa-bbbb-cccc-dddddddd',
        'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
-- Sesión 2
INSERT INTO event_sessions (id, event_id, tenant_id, name, session_date, duration_minutes, session_order, created_at)
VALUES ('sess-002-aaaa-bbbb-cccc-dddddddd',
        'event-001-aaaa-bbbb-cccc-dddddddd',
        'tenant-001-aaaa-bbbb-cccc-dddddddd',
...
VALUES ('event-001-aaaa-bbbb-cccc-dddddddd',
        'user-org-0002-aaaa-bbbb-cccccccc',
        'INSTRUCTOR',
        CURRENT_TIMESTAMP);
...
INSERT INTO participants (
    ...
    'part-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO enrollments (
    ...
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'event-001-aaaa-bbbb-cccc-dddddddd',
    'part-001-aaaa-bbbb-cccc-dddddddd',
    'COMPLETED',
...
INSERT INTO attendance_records (
    ...
    'attn-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'sess-001-aaaa-bbbb-cccc-dddddddd',
    TRUE,
    'user-org-0002-aaaa-bbbb-cccccccc',
    CURRENT_TIMESTAMP,
...
INSERT INTO attendance_records (
    ...
    'attn-002-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'sess-002-aaaa-bbbb-cccc-dddddddd',
    TRUE,
    'user-org-0002-aaaa-bbbb-cccccccc',
    CURRENT_TIMESTAMP,
...
INSERT INTO evaluation_results (
    ...
    'eval-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO payment_records (
    ...
    'pay-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'CONFIRMED',
    500.00,
...
INSERT INTO eligibility_evaluations (
    ...
    'elev-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'policy-001-aaaa-bbbb-cccc-dddddddd',
    'ELIGIBLE',
    '[{"conditionId":"cond-001-aaaa-bbbb-cccc-dddddddd","type":"MIN_ATTENDANCE","passed":true,"value":100.0,"threshold":80.0},{"conditionId":"cond-002-aaaa-bbbb-cccc-dddddddd","type":"MIN_SCORE","passed":true,"value":85.0,"threshold":70.0},{"conditionId":"cond-003-aaaa-bbbb-cccc-dddddddd","type":"PAYMENT_REQUIRED","passed":true,"value":null,"threshold":null}]',
    '{"enrollmentId":"enrl-001-aaaa-bbbb-cccc-dddddddd","attendancePercentage":100.0,"overallScore":85.0,"paymentStatus":"CONFIRMED","evaluatedAt":"2024-07-21T18:00:00Z"}',
    CURRENT_TIMESTAMP
);
...
INSERT INTO issuance_requests (
    ...
    'ireq-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'elev-001-aaaa-bbbb-cccc-dddddddd',
    'enrl-001-aaaa-bbbb-cccc-dddddddd',
    'part-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO credentials (
    ...
    'cred-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'CERTIFICATE',
    'CERT-2024-00001',
    'part-001-aaaa-bbbb-cccc-dddddddd',
    ...
    'SIMULATOR',
    'tx-001-aaaa-bbbb-cccc-dddddddd',
    CURRENT_TIMESTAMP,
    'http://localhost:8080/api/public/verify/cred-001-aaaa-bbbb-cccc-dddddddd',
    'http://localhost:8080/api/public/qr/cred-001-aaaa-bbbb-cccc-dddddddd',
    'http://localhost:8080/api/credentials/cred-001-aaaa-bbbb-cccc-dddddddd/document',
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
);
...
INSERT INTO blockchain_records (
    ...
    'bcrec-001-aaaa-bbbb-cccc-dddddddd',
    'tenant-001-aaaa-bbbb-cccc-dddddddd',
    'cred-001-aaaa-bbbb-cccc-dddddddd',
    'a3f5c8d2e9b1f4a7c0e3d6b9f2a5c8e1d4b7f0a3c6e9b2f5a8c1e4d7b0f3a6c9',
    'tx-001-aaaa-bbbb-cccc-dddddddd',
...
INSERT INTO verification_requests (
    ...
    'vreq-001-aaaa-bbbb-cccc-dddddddd',
    'cred-001-aaaa-bbbb-cccc-dddddddd',
    'QR',
    'VALID',
    '127.0.0.1',
...
INSERT INTO audit_entries (
    ...
    ('aud-001', 'user-admin-0001-aaaa-bbbb-cccccccc', 'USER', 'Dr. Carlos Mendoza',
     'tenant-001-aaaa-bbbb-cccc-dddddddd',
     'TENANT_ACTIVATED', 'TENANT', 'tenant-001-aaaa-bbbb-cccc-dddddddd', 'SUCCESS',
     '192.168.1.100', CURRENT_TIMESTAMP,
     '{"action":"Tenant activated by Super Admin"}'),

    ('aud-002', 'user-org-0002-aaaa-bbbb-cccccccc', 'USER', 'Lic. María González',
     'tenant-001-aaaa-bbbb-cccc-dddddddd',
     'EVENT_PUBLISHED', 'EVENT', 'event-001-aaaa-bbbb-cccc-dddddddd', 'SUCCESS',
     '192.168.1.101', CURRENT_TIMESTAMP,
     '{"eventName":"Taller de Python Avanzado — Edición 2024"}'),

    ('aud-003', 'user-org-0002-aaaa-bbbb-cccccccc', 'USER', 'Lic. María González',
     'tenant-001-aaaa-bbbb-cccc-dddddddd',
     'ENROLLMENT_CREATED', 'ENROLLMENT', 'enrl-001-aaaa-bbbb-cccc-dddddddd', 'SUCCESS',
     '192.168.1.101', CURRENT_TIMESTAMP,
    ...
    ('aud-004', 'SYSTEM', 'SYSTEM', 'EligibilityEvaluator',
     'tenant-001-aaaa-bbbb-cccc-dddddddd',
     'ELIGIBILITY_EVALUATED', 'ENROLLMENT', 'enrl-001-aaaa-bbbb-cccc-dddddddd', 'SUCCESS',
     NULL, CURRENT_TIMESTAMP,
     '{"result":"ELIGIBLE","conditionsPassed":3,"conditionsTotal":3}'),

    ('aud-005', 'SYSTEM', 'SYSTEM', 'IssuanceEngine',
     'tenant-001-aaaa-bbbb-cccc-dddddddd',
     'CREDENTIAL_ISSUED', 'CREDENTIAL', 'cred-001-aaaa-bbbb-cccc-dddddddd', 'SUCCESS',
     NULL, CURRENT_TIMESTAMP,
